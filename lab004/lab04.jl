...
begin 
	...
	plt02 = plot(X, Y, 
				...
				ylabel="y", 
				legend=false)
	savefig(plt02, "JL.lab0411-JL.png")
...
begin 
	...
	plt01 = plot(sol, 
				...
				ylabel="x, y", 
				legend=false)
	savefig(plt01, "JL.lab00430-JL.png")
	...
	plt02 = plot(X, Y, 
				...
				ylabel="y", 
				legend=false)
	savefig(plt02, "JL.lab00431-JL.png")
...
begin 
	...
	plt01 = plot(sol, 
				...
				ylabel="x, y", 
				legend=false)
	savefig(plt01, "JL.lab00420-JL.png")
	...
	plt02 = plot(X, Y, 
				...
				ylabel="y", 
				legend=false)
	savefig(plt02, "JL.lab00421-JL.png")
...
git-tree-sha1 = "61d1c15e207939bd591ef81be31293c66f9f1905"
